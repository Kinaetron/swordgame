...
namespace EndersEditorCommon
{
    public class ContentBuilder : IDisposable
    {
        ...
        public static List<string> pipelineAssemblies = new List<string>();
        ...
        /// <summary>
        /// Gets the build directory directory
        /// </summary>
        ...
        public ContentBuilder(string[] pipeAssemblies)
        {
            // add basic pipeline importers           
            pipelineAssemblies.Add("Microsoft.Xna.Framework.Content.Pipeline.FBXImporter" + xnaVersion);
            pipelineAssemblies.Add("Microsoft.Xna.Framework.Content.Pipeline.XImporter" + xnaVersion);
            pipelineAssemblies.Add("Microsoft.Xna.Framework.Content.Pipeline.TextureImporter" + xnaVersion);
            pipelineAssemblies.Add("Microsoft.Xna.Framework.Content.Pipeline.EffectImporter" + xnaVersion);

            foreach (string p in pipeAssemblies)
            {
                pipelineAssemblies.Add(p);
            }
        ...
        /// </summary>
        public ContentBuilder(List<string> pipeAssemblies)
        {
            // add basic pipeline importers           
            pipelineAssemblies.Add("Microsoft.Xna.Framework.Content.Pipeline.FBXImporter" + xnaVersion);
            pipelineAssemblies.Add("Microsoft.Xna.Framework.Content.Pipeline.XImporter" + xnaVersion);
